...
export const compoundIterator = (
  ...
  const requirePending = () => {
    ...
    while (nInclusionsRemaining !== 0 && !queue.isEmpty()) {
      ...
      let inclusion: HeapElement | undefined;
      do {
      ...
      while (!queue.isEmpty() && queue.front().head === inclusionComparable) {
...
class HeapElement {
  ...
  public constructor(inclusion: boolean, it: DateRecurrenceIterator) {
